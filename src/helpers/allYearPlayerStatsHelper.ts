...
export function returnStatsForAllYears(statsArray: FullStatsFile[]) {
...
export function returnPlayerStatsForAllYears(statsArray: FullStatsFile[]) {
    ...
    const collatedTeamStats = returnTeamStatsForAllYears(statsArrayCopy);

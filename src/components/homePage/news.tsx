    ...
    return (
        <div id="news">
            ...
            <Row xs={1} lg={3} className="g-4 align-items-start">
                ...
                <Col>
                    <NewsItem
                        title="GREEN OPENING DATE"
                        openingText="The green opens on Friday 28th March."
                        mainText="We'll be having a social in the evening to celebrate the green opening for the new season. Members and non-members are welcome."
